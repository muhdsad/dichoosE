...
export default function AddProductPage() {
    ...
    const [product, setProduct] = useState({
        ...
        barcode: '',
        brand: '',
        reorderLevel: '5', // Default alert when stock reaches 5
        location: '',
        dietary: 'None',
        expiryDate: '',
        batchNumber: '',
    ...
    const handleCreateCategory = async (e) => {
        ...
        try {
            // Find Tailwind class for color matching
            const colorObj = PASTEL_COLORS.find(c => c.value === newCatColor) || PASTEL_COLORS[1];
            // Get standard background color class name (e.g., bg-green-100 instead of bg-green-50 border-green-200)
            ...
            // Automatically check the new category
            setProduct(prev => ({
                ...prev,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Reset state
            setProduct({
                name: '', price: '', mrp: '', unit: '', stock: '', description: '', image: '',
                categories: [], subcategory: '', offerPrice: '', offerStart: '', offerEnd: '',
                barcode: '', brand: '', reorderLevel: '5', location: '', dietary: 'None',
                expiryDate: '', batchNumber: '', isPublished: true
            });
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                <div className="bg-gradient-to-r from-primary/80 to-green-600 px-8 py-6 text-white flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-extrabold tracking-tight">Add New Hypermarket Product</h1>
                        <p className="text-green-50 text-sm mt-1">Configure basic details, offer campaigns, and hypermarket inventory status.</p>
                    </div>
                ...
                <div className="p-8">
                    {message && (
                        <div className={`p-4 mb-6 rounded-xl flex items-center ${message.includes('Error') ? 'bg-red-50 border border-red-200 text-red-700' : 'bg-green-50 border border-green-200 text-green-700'}`}>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-6 animate-fadeIn">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        placeholder="Briefly describe the product flavor, ingredients, dimensions or specifications..."
                                        className="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm p-3 border text-black"
                                    ></textarea>
                                </div>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex shadow-sm rounded-lg overflow-hidden">
                                            ...
                                            <button
                                                ...
                                                title="Generate mock EAN-13 barcode"
                                            >
                                                <FaBarcode /> Generate
                                            </button>
                                        </div>
                        ...
                        <div className="flex justify-end gap-4 border-t border-gray-100 pt-6 mt-8">
                            <button
                                type="submit"
                                disabled={loading}
                                className={`px-6 py-3 border border-transparent rounded-xl shadow-md text-sm font-bold text-white bg-primary hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                            >
